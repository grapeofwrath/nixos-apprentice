# Auto-generated using compose2nix v0.3.1.
{
  ...
  virtualisation.oci-containers.containers."ente-server-minio-provision" = {
    image = "minio/mc";
    volumes = [
      "/home/marcus/dotfiles/docker-compose/ente/scripts/compose/minio-provision.sh:/provision.sh:ro"
      "ente-server_minio-data:/data:rw"
    ];
    dependsOn = [
      "ente-server-minio"
  ...
  virtualisation.oci-containers.containers."ente-server-museum" = {
    ...
    volumes = [
      "/home/marcus/dotfiles/docker-compose/ente/data:/data:ro"
      "/home/marcus/dotfiles/docker-compose/ente/museum.yaml:/museum.yaml:ro"
      "/home/marcus/dotfiles/docker-compose/ente/scripts/compose/credentials.yaml:/credentials.yaml:ro"
